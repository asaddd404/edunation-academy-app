  ...
  <div>
    ...
    <div v-else class="space-y-6">
      <div
        ...
        :key="section.id"
        class="rounded-2xl border border-border bg-card p-4 transition-all duration-200"
      >
        ...
        <ul class="space-y-2">
          <li v-for="lesson in section.lessons" :key="lesson.id">
            <router-link
              ...
              class="flex items-center justify-between rounded-xl border border-border px-4 py-3 transition-all duration-200 hover:scale-[1.01] hover:border-accent"
            >
            ...
            <div v-else class="flex items-center justify-between rounded-xl border border-border px-4 py-3 opacity-50">
              <span>{{ lesson.title }}</span>
          ...
          <li v-if="section.has_test">
            <router-link
              ...
              class="flex items-center justify-between rounded-xl border border-accent/40 px-4 py-3 transition-all duration-200 hover:scale-[1.01] hover:border-accent"
            >
